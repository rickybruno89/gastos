...
export default function Navbar({ session }: { session: Session | null }) {
  ...
  return (
    <Disclosure as="div" className="bg-gray-800 fixed top-0 w-full z-50">
        ...
        <div className="relative flex h-14 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            ...
            <DisclosureButton
              ...
              className=" group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus-visible:outline-none focus:outline-none"
            >
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex flex-shrink-0 items-center">
              <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-500 text-shadow">
                GastApp
              </h1>
            </div>
